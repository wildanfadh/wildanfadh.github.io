					...
					<div class="col-md-8 col-md-offset-2 text-center">
						<div class="display-t js-fullheight">
							<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
								<div class="profile-thumb" style="background: url(images/wildan.jpg);"></div>
								<h1><span>Wildan Fadhlulloh</span></h1>
								<h3><span>Web Developer / Mobile Developer</span></h3>
								<p>
		...
		<div id="fh5co-about" class="animate-box">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<ul class="info">
							<li><span class="first-block">Full Name:</span><span class="second-block">Wildan
									Fadhlulloh</span></li>
							...
							<li><span class="first-block">Website:</span><span class="second-block">www.wildanfadh.com</span></li>
							...
							<li class="animate-box timeline-unverted">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h3 class="timeline-title">FullStack Developer</h3>
										<span class="company">CV. PRIMA GROUP - 2020 - Current</span>
									</div>
							...
							<li class="timeline-inverted animate-box">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										...
										<span class="company">BLKK Wahid Hasyim - 2019 - 2020</span>
									</div>
									<div class="timeline-body">
							...
							<li class="timeline-inverted animate-box">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										...
										<span class="company">Magistra Utama Surabaya - 2018 - 2019</span>
									</div>
									<div class="timeline-body">
							...
							<li class="animate-box timeline-unverted">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										...
										<span class="company">SMK Roudlotun Nasyiin - 2015 - 2018</span>
									</div>
									<div class="timeline-body">
										<p>Mojokerto, Jawa Timur, Indonesia.</p>
									</div>
					...
					<div class="row">
						...
						<div class="col-md-4 text-center">
							...
							<div class="feature-left">
								...
								<div class="feature-copy">
									<h3>Mobile Developent</h3>
									<p>1+ years work experience</p>
								</div>
							</div>
		...
		<div id="fh5co-skills" class="animate-box">
			<div class="container">
				...
				<div class="row row-pb-md">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 text-center">
						<div class="chart" data-percent="80"><span><strong>ReactJs</strong>80%</span></div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 text-center">
						<div class="chart" data-percent="75"><span><strong>NodeJs</strong>75%</span></div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 text-center">
						<div class="chart" data-percent="90"><span><strong>ReactNative</strong>90%</span></div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 text-center">
						<div class="chart" data-percent="80"><span><strong>Flutter</strong>80%</span></div>
					</div>
				</div>
				<!-- <div class="row">
					<div class="col-md-6">
						...
						<div class="progress-wrap">
							<h3><span class="name-left">ReactNative</span><span class="value-right">90%</span></h3>
							<div class="progress">
